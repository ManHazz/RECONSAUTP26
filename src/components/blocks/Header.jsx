      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="flex-1 flex justify-end items-center gap-4">
          <button
            ...
            className="hidden md:flex items-center gap-2 px-6 py-2 bg-black text-white rounded-full font-bold hover:bg-[#5a38d4] hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer"
          >
        ...
        <div className="md:hidden bg-[#ffffffcc] text-black backdrop-blur-md px-6 py-6 space-y-6 shadow-xl border-t border-gray-200 font-bold">
          ...
          <div className="pt-4 mt-4 border-t border-gray-300">
            <button
              ...
              className="w-full flex justify-center items-center gap-2 py-3 bg-black text-white rounded-lg font-bold hover:bg-[#5a38d4] transition-colors text-lg cursor-pointer"
            >
